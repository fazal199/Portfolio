...
const SkillCard = ({ skill }: any) => (
    <div className="flex cursor-pointer items-center bg-quaternary rounded-lg shadow-md shadow-tertiary  p-3 transition-all duration-300 hover:shadow-lg hover:shadow-white hover:-translate-y-1">
       <div>
            <img
                loading='lazy'
                src={skill.src}
